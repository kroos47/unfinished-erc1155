...
@app.route('/api/collect/<token_id>')
def factory(token_id):
    token_id = int(token_id)
    if token_id == 0:
        name = "Pa Mythical"
        description = "When you purchase this option, you will receive a mythical blade. " 
                      
        image_url = _compose_image(['images/factory/pa_mythical.png'], token_id, "collectibles")
        num_inside = 1
    elif token_id == 1:
        name = "Pa immortal"
        description = "When you purchase this option, you will receive immortal balde " 
                      
        image_url = _compose_image(['images/factory/pa_immortal.png'], token_id, "Collectibles")
        num_inside = 1
    elif token_id == 2:
        name = "Arcana"
        description = "When you purchase this option, you will receive PA arcana"
        image_url = _compose_image(['images/box/pa_arcanan.png'], token_id, "Collectibles")
        num_inside = 1
